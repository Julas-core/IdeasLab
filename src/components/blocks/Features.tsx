        ...
        <section className="bg-gray-50 py-16 md:py-32 dark:bg-transparent">
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-bold tracking-tight sm:text-5xl text-foreground dark:text-foreground">
                        ...
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit p-6">
                                <div className="relative flex h-24 w-56 items-center">
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-semibold text-foreground dark:text-foreground">AI</span>
                                </div>
                                <h2 className="mt-6 text-center text-3xl font-semibold text-foreground dark:text-foreground">AI-Powered Analysis</h2>
                                <p className="mt-2 text-center text-sm text-muted-foreground">Leverage advanced AI to dissect your business ideas, providing deep insights and validation.</p>
                            </CardContent>
                        </Card>
